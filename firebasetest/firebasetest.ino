...
#define WEBSITE "library-room.firebaseapp.com"
#define API_key "AIzaSyANpCrevyF0ZQDcDXy-QE2-P3hUdc0xzDk"
...
void loop(void)
{
  ...
  Serial.println(F("Maybe Conneccted"));
